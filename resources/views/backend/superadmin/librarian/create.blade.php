<form method="POST" class="d-block ajaxForm" action="{{ route('librarian.store') }}">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="name" name = "other_name" required>
        ...
        <div class="form-group  col-md-12">
            <button class="btn btn-block btn-primary" type="submit">{{ translate('create_librarian') }}</button>
        </div>
    </div>
</form>
