...
class CoursesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.'.Auth::user()->role.'.lessons.courses.index', compact('courses', 'title'));
    }
    ...
    public function create()
    {
        ...
        $teachers = \App\User::where(['role' => 'teacher', 'school_id' => school_id()])->get()->pluck('first_name', 'id');
        //dd($teachers);

        return view('backend.'.Auth::user()->role.'.lessons.courses.create', compact('teachers'));
    }
