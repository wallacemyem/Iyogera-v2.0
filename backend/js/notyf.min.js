var Notyf = function() {
    ...
    n.prototype.splice = function(t, i) {
        ...
        return this.updateFn(n, e.Remove, this.notifications),
        n
    }
    ,
    ...
    var r = {
        ...
        dismissible: ((i = m = m || {})[i.Dismiss = true] = "Dismiss")
    }
      , c = (p.prototype.on = function(t, i) {
        var n;
        this.events = o(o({}, this.events), ((n = {})[t] = i,
        n))
    }
    ,
    ...
    p.prototype.removeNotification = function(t) {
        ...
        o && ((i = o.node).classList.add("notyf__toast--disappear"),
        i.addEventListener(this.animationEndEventName, n = function(t) {
            t.target === i && (i.removeEventListener(e.animationEndEventName, n),
    ...
    p.prototype._renderNotification = function(t) {
        ...
        return e && (i = n.classList).add.apply(i, e.split(" ")),
    ...
    p.prototype.getYPosition = function(t) {
        var i;
        return (null === (i = null == t ? void 0 : t.position) || void 0 === i ? void 0 : i.y) || "top"
    }
    ,
    p.prototype.adjustContainerAlignment = function(t) {
        ...
        e.setProperty("justify-content", n),
        e.setProperty("align-items", i)
    }
    ,
    p.prototype._buildNotificationCard = function(i) {
        ...
        if (a.appendChild(r),
        o.appendChild(a),
        c && (t.ripple ? (s.style.background = c,
        o.appendChild(s)) : o.style.background = c),
        t.dismissible) {
            var u = this._createHTLMElement({
                tagName: "div",
        ...
        return o.classList.add("notyf__toast--" + f),
        o
    }
    ,
    ...
    d.prototype.open = function(i) {
        ...
        var e = new s(n);
        return this._pushNotification(e),
        e
    }
    ,
    ...
    d.prototype.normalizeOptions = function(t, i) {
        ...
        return "string" == typeof i ? n.message = i : "object" == typeof i && (n = o(o({}, n), i)),
        n
    }
    ,
